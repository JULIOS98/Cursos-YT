...
class Estudiante(models.Model):
    ...
    def __str__(self):
        ...
        if self.vigencia:
            ...
            status = "BAJA"
        return txt.format(self.nombreCompleto(), self.carrera, status)
...
class Matricula(models.Model):
    ...
    def __str__(self):
        ...
        return txt.format(self.estudiante.nombreCompleto(), letra, self.curso, fechMat)